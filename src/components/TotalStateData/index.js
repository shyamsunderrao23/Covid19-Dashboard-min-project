...
class TotalStateData extends Component {
  ...
  getEachState = async () => {
    ...
    const confirmedData = {
      name: 'Confirmed',
      logo:
        'https://res.cloudinary.com/dh7ed1uf5/image/upload/v1703331603/check-mark_1_cjfmtq.jpg',
    ...
    const activeData = {
      name: 'Active',
      logo:
        'https://res.cloudinary.com/dh7ed1uf5/image/upload/v1703354095/protection_1_hwzoau.jpg',
      value: totalActive,
    }
    ...
    const recoveredData = {
      name: 'Recovered',
      logo:
        'https://res.cloudinary.com/dh7ed1uf5/image/upload/v1703354384/recovered_1_azsiy0.jpg',
      value: totalRecovered,
    }
    const deceasedData = {
      name: 'Deceased',
      logo:
        'https://res.cloudinary.com/dh7ed1uf5/image/upload/v1703354699/breathing_1_pmnrlu.jpg',
      value: totalDeceased,
    }
